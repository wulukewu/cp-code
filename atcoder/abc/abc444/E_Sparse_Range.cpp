 ...
 * Platform:       AtCoder
 * Problem:        abc444_e — Sparse Range
 * Problem URL:    https://atcoder.jp/contests/abc444/tasks/abc444_e
 *
 * Matched result: AC
 * Submission:     #73099085
 * Submission URL: https://atcoder.jp/contests/abc444/submissions/73099085
 * Submitted:      2026-02-07 21:24:11 +0800
...
void solve(){
    ...
    FOR(r, 0, n){
        ...
        while(true){
            if(brr.empty()) break;
            auto it = brr.lower_bound(val-d+1);
            if(it!=brr.end() and *it<val+d){
                auto it2 = brr.find(arr[l]);
                brr.erase(it2);
                l++;
            }else{
                break;
