 ...
 * Platform:       AtCoder
 * Problem:        abc445_d — Reconstruct Chocolate
 * Problem URL:    https://atcoder.jp/contests/abc445/tasks/abc445_d
 *
 * Matched result: AC
 * Submission:     #73316907
 * Submission URL: https://atcoder.jp/contests/abc445/submissions/73316907
 * Submitted:      2026-02-14 21:00:45 +0800
 * Language:       C++23 (GCC 15.2.0)
 * Runtime:        404 ms
 * Points:         425.0
 * Submissions:    2 total / 1 accepted
 * File commit:    2026-02-14 21:41:56 +0800
...
void solve(){
    ...
    int curw = w;
    int x = 0, y = 0;
    vector<bool>collect(n, false);
    vector<pair<int, int>>ans(n);
    map<int, set<int>>mph;
    map<int, set<int>>mpw;
    FOR(i, 0, n){
        mph[arr[i].F].insert(i);
        mpw[arr[i].S].insert(i);
    }
