...
........:::.......:::..::::..::........::
 ...
 ATCODER // abc448_d // Integer-duplicated Path
 https://atcoder.jp/contests/abc448/tasks/abc448_d

 AC // C++23 (GCC 15.2.0) // 267 ms // 400.0 pt
 #73915704 // 2026-03-07 20:48:19 +0800
 https://atcoder.jp/contests/abc448/submissions/73915704
...
void solve(){
    ...
    auto dfs = [&](auto&& self, int u, int p) -> void {
        ...
        for(int& v: G[u]){
            ...
            self(self, v, u);
            // if(visit[v]) continue;
            // if(st.find(val[v])!=st.end() or check){
            //     ans[v] = true;
            //     check = true;
            // }else{
            //     st.insert(val[v]);
