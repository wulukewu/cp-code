 ...
 * Platform:       AtCoder
 * Problem:        abc449_c — Comfortable Distance
 * Problem URL:    https://atcoder.jp/contests/abc449/tasks/abc449_c
 *
 * Matched result: AC
 * Submission:     #74090442
 * Submission URL: https://atcoder.jp/contests/abc449/submissions/74090442
 * Submitted:      2026-03-14 20:14:21 +0800
...
void solve(){
    ...
    for(auto& i: mp){
        for(int& j: i.S){
            int x = lower_bound(ALL(i.S), j+l) - i.S.begin();
            int y = upper_bound(ALL(i.S), j+r) - i.S.begin();
            int z = y-x;
            // cout << z << endl;
            ans += z;
        }
