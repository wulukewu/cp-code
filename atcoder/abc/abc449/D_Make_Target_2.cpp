 ...
 * Platform:       AtCoder
 * Problem:        abc449_d — Make Target 2
 * Problem URL:    https://atcoder.jp/contests/abc449/tasks/abc449_d
 *
 * Matched result: AC
 * Submission:     #74110851
 * Submission URL: https://atcoder.jp/contests/abc449/submissions/74110851
 * Submitted:      2026-03-14 20:53:31 +0800
 * Language:       C++23 (GCC 15.2.0)
 * Runtime:        10 ms
 * Points:         425.0
 * Submissions:    1 total / 1 accepted
 * File commit:    2026-03-14 21:44:19 +0800
...
void solve(){
    ...
    //     int res = 0;
    //     FOR(i, 0, 4){
    //         for(int j=2; j<=max(arr[i], arr[(i+1)%4]); j+=2){
    //             // 3 7 ...
    //             int a = 3 + (j/2-1)*4;
    //             // cout << a << endl;
    //             res += a;
    ...
    // int ans = 0;
    // vector<int>arr = {r, u, l, d};
    // FOR(i, 0, 4) arr[i] = abs(arr[i]);
    // ans += cal(arr);
