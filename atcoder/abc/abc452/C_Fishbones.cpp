...
........:::.......:::..::::..::........::
 ...
 ATCODER // abc452_c // Fishbones
 https://atcoder.jp/contests/abc452/tasks/abc452_c

 AC // C++23 (GCC 15.2.0) // 18 ms // 300.0 pt
 #74663664 // 2026-04-04 20:26:11 +0800 // 2 attempts
 https://atcoder.jp/contests/abc452/submissions/74663664
...
void solve(){
    ...
    cin >> m;
    vector<string>brr(m);
    // vector<set<string>>crr(12);
    bool crr[15][15][26] = {false};
    FOR(i, 0, m){
        cin >> brr[i];
        // crr[brr[i].size()].insert(brr[i]);
        int l = brr[i].size();
        FOR(j, 0, l){
            crr[l][j][brr[i][j]-'a'] = true;
        }
    }
