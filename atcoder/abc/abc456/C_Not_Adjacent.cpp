 ...
 * Platform:       AtCoder
 * Problem:        abc456_c — Not Adjacent
 * Problem URL:    https://atcoder.jp/contests/abc456/tasks/abc456_c
 *
 * Matched result: AC
 * Submission:     #75425938
 * Submission URL: https://atcoder.jp/contests/abc456/submissions/75425938
 * Submitted:      2026-05-02 20:16:29 +0800
...
void solve(){
    ...
    FOR(i, 0, n){
        FOR(j, i, n){
            if((j<n-1 and s[j]==s[j+1]) or j==n-1){
                int a = j-i+1;
                cnt += a*(a+1)/2;
                cnt %= M;
                i = j;
