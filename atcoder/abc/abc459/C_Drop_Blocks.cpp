 ...
 * Platform:       AtCoder
 * Problem:        abc459_c — Drop Blocks
 * Problem URL:    https://atcoder.jp/contests/abc459/tasks/abc459_c
 *
 * Matched result: AC
 * Submission:     #76061110
 * Submission URL: https://atcoder.jp/contests/abc459/submissions/76061110
 * Submitted:      2026-05-23 20:41:47 +0800
...
void solve(){
    ...
    //         y--;
    //         int x = brr[y];
    //         int z = upper_bound(ALL(arr), arr[x]) - arr.begin() - 1;
    //         arr[z]++;
    //         brr[y] = z;
    //         brr[crr[z]] = y;
    //         crr[z] = y;
