 ...
 * Platform:       AtCoder
 * Problem:        abc459_e — Select from Subtrees
 * Problem URL:    https://atcoder.jp/contests/abc459/tasks/abc459_e
 *
 * Matched result: AC
 * Submission:     #76084070
 * Submission URL: https://atcoder.jp/contests/abc459/submissions/76084070
 * Submitted:      2026-05-23 21:32:03 +0800
 * Language:       C++23 (GCC 15.2.0)
 * Runtime:        72 ms
 * Points:         450.0
 * Submissions:    1 total / 1 accepted
 * File commit:    2026-05-23 21:42:50 +0800
...
void solve(){
    ...
    vector<int>invfact(sd+1);
    int fact = 1;
    FOR(i, 1, sd+1){
        timesmod(fact, i);
    }
    invfact[sd] = POW(fact, MOD-2);
    ...
    int ans = 1;
    FOR(i, 0, n){
        int a = sumc[i] - sumd[i] + drr[i];
        timesmod(ans, nCr(a, drr[i]));
    }
    cout << ans << endl;
}
