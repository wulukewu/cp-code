 ...
 * Platform:       AtCoder
 * Problem:        abc460_c — Sushi
 * Problem URL:    https://atcoder.jp/contests/abc460/tasks/abc460_c
 *
 * Matched result: AC
 * Submission:     #76243508
 * Submission URL: https://atcoder.jp/contests/abc460/submissions/76243508
 * Submitted:      2026-05-30 20:20:26 +0800
...
void solve(){
    ...
    while(a<n and b<m){
        ...
        if(brr[b]<=arr[a]*2 and a<n and b<m){
            a++;
            b++;
            cnt++;
        }
