 ...
 * Platform:       AtCoder
 * Problem:        abc462_d — Accomplice
 * Problem URL:    https://atcoder.jp/contests/abc462/tasks/abc462_d
 *
 * Matched result: AC
 * Submission:     #76644108
 * Submission URL: https://atcoder.jp/contests/abc462/submissions/76644108
 * Submitted:      2026-06-13 20:37:17 +0800
...
void solve(){
    ...
    // }
    // sort(ALL(v));
    // // FOR(i, 0, n) cout << v[i].F << ' ' << v[i].S << endl;

    // FOR(i, 1, m){
    //     arr[i] += arr[i-1];
    // }
    // // FOR(i, 0, 25) cout << arr[i] << ' ';

    // FOR(t, 0, m){
    //     if(arr[t]<=1) continue;
    //     cout << t << ' ';
    //     int it = upper_bound(ALL(v), make_pair(t, 0)) - v.begin() - 1;
    //     cout << it << endl;
    // }
}
