 ...
 * Platform:       AtCoder
 * Problem:        abc467_d — Concentric Circles
 * Problem URL:    https://atcoder.jp/contests/abc467/tasks/abc467_d
 *
 * Matched result: AC
 * Submission:     #77612335
 * Submission URL: https://atcoder.jp/contests/abc467/submissions/77612335
 * Submitted:      2026-07-18 20:36:57 +0800
...
void solve(){
    ...
    i128 c = (i128)ux*vy-(i128)uy*vx;
    if(c!=0){
        cout << "Yes" << endl;
        return;
    }

    i128 wx = (i128)rx+sx-px-qx;
    i128 wy = (i128)ry+sy-py-qy;
    i128 d = (i128)ux*wx+(i128)uy*wy;
    if(d==0){
        cout << "Yes" << endl;
    }else{
        cout << "No" << endl;
