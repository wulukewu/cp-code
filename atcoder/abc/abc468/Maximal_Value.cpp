 ...
 * Platform:       AtCoder
 * Problem:        abc468_a — Maximal Value
 * Problem URL:    https://atcoder.jp/contests/abc468/tasks/abc468_a
 *
 * Matched result: AC
 * Submission:     #77813151
 * Submission URL: https://atcoder.jp/contests/abc468/submissions/77813151
 * Submitted:      2026-07-25 20:04:27 +0800
...
void solve(){
    ...
    FOR(i, 0, n-2){
        // cout << i << endl;
        if(v[i]<v[i+1] and v[i+1]>v[i+2]) cnt++;
    }
    cout << cnt << endl;
}
