...
........:::.......:::..::::..::........::
 ...
 ATCODER // abc469_b // Isolated Seats
 https://atcoder.jp/contests/abc469/tasks/abc469_b

 AC // C++23 (GCC 15.2.0) // 1 ms // 200.0 pt
 #78007315 // 2026-08-01 20:06:00 +0800
 https://atcoder.jp/contests/abc469/submissions/78007315
...
void solve(){
    ...
    FOR(i, 0, n){
        if(s[i]=='o') continue;
        if(i>0 and s[i-1]=='o') continue;
        if(i<n-1 and s[i+1]=='o') continue;
        cnt++;
    }
    cout << cnt << endl;
}
