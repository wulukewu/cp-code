...
........:::.......:::..::::..::........::
 ...
 ATCODER // abc472_e // Odd Cycle
 https://atcoder.jp/contests/abc472/tasks/abc472_e

 AC // C++23 (GCC 15.2.0) // 64 ms // 450.0 pt
 #78622521 // 2026-08-22 20:54:16 +0800
 https://atcoder.jp/contests/abc472/submissions/78622521
    ...
    while(!q.empty()){
        ...
        for(int v: g[u]){
            if(color[v]==-1){
                ...
                dep[v] = dep[u]+1;
                q.push(v);
            }else if(v!=par[u] and color[v]==color[u]){
                x = u;
                y = v;
                break;
            }
