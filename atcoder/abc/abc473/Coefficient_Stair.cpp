 ...
 * Platform:       AtCoder
 * Problem:        abc473_d — Coefficient Stair
 * Problem URL:    https://atcoder.jp/contests/abc473/tasks/abc473_d
 *
 * Matched result: AC
 * Submission:     #78801177
 * Submission URL: https://atcoder.jp/contests/abc473/submissions/78801177
 * Submitted:      2026-08-29 20:36:43 +0800
 * Language:       C++23 (GCC 15.2.0)
 * Runtime:        95 ms
 * Points:         400.0
 * Submissions:    3 total / 1 accepted
 * File commit:    2026-08-29 21:44:05 +0800
...
void solve(){
    ...
    // vector<int>v(n, -1);
    // auto dfs = [&](auto&& self, int si, int sk) -> void {
    //     if(si==0){
    //         if(sk==0){
    //             ans.PB(v);
    //         }
    //         return;
    //     }
    //     for(int a=0; si*a<=sk;a++){
    //         // v.PB(a);
    //         v[si-1] = a;
    //         self(self, si-1, sk-si*a);
    //         // v.pop_back();
    //         v[si-1] = -1;
    //     }
    // };
