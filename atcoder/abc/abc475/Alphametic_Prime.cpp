 ...
 * Platform:       AtCoder
 * Problem:        abc475_d — Alphametic Prime
 * Problem URL:    https://atcoder.jp/contests/abc475/tasks/abc475_d
 *
 * Matched result: AC
 * Submission:     #79212336
 * Submission URL: https://atcoder.jp/contests/abc475/submissions/79212336
 * Submitted:      2026-09-12 20:54:02 +0800
...
void solve(){
    ...
    auto check = [](string s, string t) -> bool {
        ...
        FOR(i, 0, s.size()){
            int c = s[i]-'a';
            int d = t[i]-'0';
            if(mp1[c]!=-1 and mp1[c]!=d) return false;
            if(mp2[d]!=-1 and mp2[d]!=c) return false;
            mp1[c] = d;
            mp2[d] = c;
        }
        return true;
