...
........:::.......:::..::::..::........::
 ...
 ATCODER // abc477_f // Count Cells in a Window
 https://atcoder.jp/contests/abc477/tasks/abc477_f

 AC // C++23 (GCC 15.2.0) // 188 ms // 525.0 pt
 #79565103 // 2026-09-26 21:43:11 +0800
 https://atcoder.jp/contests/abc477/submissions/79565103
...
void solve(){
    ...
    BIT<int>cntL(m+1), sumL(m+1);
    BIT<int>cntR(m+1), sumR(m+1);
    int now = 0;
    for(auto [k, x, id, sign]: qry){
        while(now<k){
            now++;
            cntL.up(l[now], 1);
            sumL.up(l[now], l[now]);
