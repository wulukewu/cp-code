...
........:::.......:::..::::..::........::
 ...
 ATCODER // abc477_e // Wheel Distance
 https://atcoder.jp/contests/abc477/tasks/abc477_e

 AC // C++23 (GCC 15.2.0) // 88 ms // 450.0 pt
 #79545370 // 2026-09-26 20:58:15 +0800
 https://atcoder.jp/contests/abc477/submissions/79545370
...
void solve(){
    ...
    while(q--){
        ...
        int dis = pre[t]-pre[s];
        dis = min(dis, pre[n]-dis);
        int ans = min(dis, d[s]+d[t]);
        cout << ans << endl;
    }
}
