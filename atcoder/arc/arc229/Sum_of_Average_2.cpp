...
........:::.......:::..::::..::........::
 ...
 ATCODER // arc229_c // Sum of Average 2
 https://atcoder.jp/contests/arc229/tasks/arc229_c

 AC // C++23 (GCC 15.2.0) // 21 ms // 500.0 pt
 #78981560 // 2026-09-05 21:45:01 +0800
 https://atcoder.jp/contests/arc229/submissions/78981560
...
void solve(){
    ...
    if(o>=2){
        int d = 2 * min(e, o-1);
        mx = max(mx, odd[0]+odd[1]+d);
    }
    if(e>=2){
        int d = 2 * min(o, e-1);
        mx = max(mx, even[0]+even[1]+d);
    }
    if(o>=1 and e>=1){
        int d = 2 * min(o, e) - 1;
        mx = max(mx, odd[0]+even[0]+d);
    }
    int ans = (sum*2-mx) / 2;
    cout << ans << endl;
}
