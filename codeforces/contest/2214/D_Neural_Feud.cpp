 ...
 * Platform:       Codeforces
 * Problem:        2214D — Neural Feud
 * Problem URL:    https://codeforces.com/contest/2214/problem/D
 *
 * Matched result: AC
 * Submission:     #369242007
 * Submission URL: https://codeforces.com/contest/2214/submission/369242007
 * Submitted:      2026-04-02 00:11:47 +0800
 * Language:       C++23 (GCC 14-64, msys2)
 * Runtime:        31 ms
 * Memory:         0 B
 * Tags:           *special, strings
 * Submissions:    7 total / 1 accepted
...
void solve(){
    string ans[8] = {"walk", "no", "no", "no", "yes", "yes", "backwards", "7"};
    int n;
    cin >> n;
    cout << ans[n-1];
    // FOR(i, 0, 8) cout << ans[i] << endl;
}
