...
void solve(){
    string s;
    getline(cin, s);
    if(s=="Do you think this contest should be rated?") cout << "Yes";
    else if(s=="Are you a verified human?") cout << "Yes, I can attest to my status as a thoroughly validated, carbon-based biological entity.";
    else cout << "NA";
}
